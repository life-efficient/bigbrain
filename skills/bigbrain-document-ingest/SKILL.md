...
- Preserve the raw input under `.artifacts/` when the original document matters
...
4. Preserve the original file when useful:
   - store it under `.artifacts/<artifact-slug>/`
   - link the canonical page to the artifact
...
- whether a raw artifact was preserved
