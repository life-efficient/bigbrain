...
- Keep node sizing independent from node shape and colour. Offer Small, Medium, and Large graph controls at approximately 1x, 2x, and 3x the compact baseline, default new and previously unsized preferences to Medium, and preserve the selected size while zooming.
