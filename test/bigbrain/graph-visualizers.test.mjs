...
test('graph palettes provide technical presets and editable type colors', () => {
  assert.deepEqual(GRAPH_COLOR_PALETTE_OPTIONS.map(({ id }) => id), ['jarvis', 'terminal', 'cobalt', 'soft', 'crimson-loom', 'neural-lumen', 'thermal', 'irezumi', 'desert', 'arctic', 'woodland', 'digital', 'urban', 'blue-tiger', 'red-tiger', 'fall', 'spectral', 'custom']);
