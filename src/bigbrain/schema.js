...
export function schemaDescription() {
  return {
    ...
    timeline_entry: {
      ...
      provenance: 'source event metadata for this entry, including event_id, source_type, source_label, source_message, and optional source URL/listener/raw reference',
    ...
    notes: [
      ...
      'Timeline entries carry occurred_at, recorded_at, a Markdown change description, per-entry source_type/source_message provenance, and optional significance; new entries render newest first.',
