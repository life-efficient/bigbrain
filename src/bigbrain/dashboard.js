  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      .force3d-surface { position: absolute; inset: 0; min-width: 0; min-height: 0; overflow: hidden; border-radius: 18px; background: radial-gradient(circle at 50% 48%, rgba(22,32,50,0.56), rgba(9,10,14,0.98) 72%); }
      .force3d-surface > div { width: 100% !important; height: 100% !important; }
      .force3d-surface canvas { display: block; width: 100% !important; height: 100% !important; max-width: 100%; max-height: 100%; outline: none; }
